...
public class Actividad_01_UD3_ED 
{
    ...
    private static BufferedInputStream CadenaEntradaIntermedia = null;

    public static void inicializateFiles() throws FileNotFoundException
    {
        CadenaEntrada = new FileInputStream(NombreArchivo);
        CadenaEntradaIntermedia = new BufferedInputStream(CadenaEntrada);
    }
    ...
    {        
        ...
        finally 
        {
            try 
            {
                if( CadenaEntradaIntermedia != null && CadenaEntrada != null )
                {
                    CadenaEntrada.close();
                    CadenaEntradaIntermedia.close();
                }                
            } 
            catch (IOException ex) 
            {
